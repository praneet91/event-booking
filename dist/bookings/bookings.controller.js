...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Booking created successfully', type: booking_entity_1.Booking }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Booking cancelled successfully', type: booking_entity_1.Booking }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all bookings for a specific event' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return all bookings for the event', type: [booking_entity_1.Booking] }),
    __param(0, (0, common_1.Param)('eventId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BookingsController.prototype, "findByEventId", null);
